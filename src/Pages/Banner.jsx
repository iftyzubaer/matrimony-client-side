const Banner = () => {
    return (
        <div className="text-center text-neutral-content bg-cover max-h-screen bg-no-repeat rounded-lg" style={{ backgroundImage: 'url(https://i.ibb.co/KqX1sW6/image.png)' }}>
